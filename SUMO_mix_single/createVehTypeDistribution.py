...
def get_options(args=None):
    ...
    argParser.add_argument(
        "-s", "--size", type=int, default=1300, dest="vehicleCount", help="number of vTypes in the distribution")
    argParser.add_argument(
        "-d", "--decimal-places", type=int, default=3, dest="decimalPlaces", help="number of decimal places for " +
        "numeric attribute values")
    argParser.add_argument(
        "--resampling", type=int, default=1300, dest="nrSamplingAttempts", help="number of attempts to resample a " +
